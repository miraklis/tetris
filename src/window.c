...
Window* createWindow(int wx, int wy, int width, int height, Color* backgroundColor, bool hasBorder)
{
    ...
    f->vertices = (VertexSimple*)malloc(sizeof(VertexSimple) * f->vertCount);
    ...
    f->vertices[cnt++] = (VertexSimple){bx, by, backgroundColor->r, backgroundColor->g, backgroundColor->b, backgroundColor->a};
    f->vertices[cnt++] = (VertexSimple){bx + bw, by, backgroundColor->r, backgroundColor->g, backgroundColor->b, backgroundColor->a};
    f->vertices[cnt++] = (VertexSimple){bx, by + bh, backgroundColor->r, backgroundColor->g, backgroundColor->b, backgroundColor->a};
    f->vertices[cnt++] = (VertexSimple){bx, by + bh, backgroundColor->r, backgroundColor->g, backgroundColor->b, backgroundColor->a};
    f->vertices[cnt++] = (VertexSimple){bx + bw, by, backgroundColor->r, backgroundColor->g, backgroundColor->b, backgroundColor->a};
    f->vertices[cnt++] = (VertexSimple){bx + bw, by + bh, backgroundColor->r, backgroundColor->g, backgroundColor->b, backgroundColor->a};
                ...
                if(i==0 || j==0 || i==height-1 || j==width-1) {
                    if(i==0 || j==0 || i==height-1 || j==width-1) {
                        updateVerticesSimple(
                            ...
                            (i * blockHeight),
                            1.0f,
                            &palette.colorGray20, &palette.colorGray60);
                    }
                }
            }
        }
